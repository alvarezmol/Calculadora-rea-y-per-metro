...
function calcularperimetrocuadrado(){
    ...
    document.getElementById("perimetroCuadrado").innerHTML = ("El perímetro de tu cuadrado es: " + perimetro.toFixed(2));
 }
 ...
 function calcularareacuadrado(){
    ...
    document.getElementById("areaCuadrado").innerHTML = ("El área de tu cuadrado es: " + area.toFixed(2));
 }
...
function calcularperimetrotriangulo(){
    ...
    document.getElementById("perimetroTriangulo").innerHTML = ("El perímetro de tu triangulo es: " + perimetrot.toFixed(2));
 }
 ...
 function calcularareatriangulo(){
    ...
    document.getElementById("areaTriangulo").innerHTML = ("El área de tu triangulo es: " + areat.toFixed(2));
 }
...
function calcularperimetrocirculo(){
    ...
    document.getElementById("perimetroCirculo").innerHTML = ("El perímetro de tu circulo es: " + perimetroc.toFixed(2));
 }
 ...
 function calcularareacirculo(){
    ...
    document.getElementById("areaCirculo").innerHTML = ("El área de tu circulo es: " + areac.toFixed(2));
 }
 ...
 function calcularalturatriangulo(){
     ...
     if (lado1 === lado2){
        ...
        alert("Esto no es un triangulo isósceles, porfavor intente de nuevo")
     }
...
let precio;
 ...
 function calcularpreciocondescuento(){
    ...
    const ahorasidcto = dctodelcupon.dcto; 
       ...
       document.getElementById("cuponvalido").innerHTML = ("El cupón fue efectuado exitosamente");
    } else {
       ...
       document.getElementById("cuponvalido").innerHTML = ("Lo siento, el cupón no es valido");
    } 
